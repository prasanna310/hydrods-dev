...
# give an average value for NA items
for(i in 1:ncol(res)){
...
soil_data=data.frame(mukey=mu.whc$mukey, depth=mu.whc$depth,fvalue=mu.whc$fval,ksat=ko,dth1=dth1,dth2=dth2,c=c1,psif=psif,tr=mu.whc$tr,  BBL=BBL, PSD=PSD, RSM=RSM, SSM=SSM, ksat_rawls=ksat_rawls)
...
rat.new <- rat.new[,c("ID", "COUNT","fvalue","ksat","dth1","dth2","psif","depth","tr",           "BBL", "PSD", "RSM", "SSM", "ksat_rawls")]
