...
STATIC_FILE_NAME_PATH_DICT = {'prcp_2010.nc4': os.path.join(DAYMET_ROOT_FILE_PATH, 'prcp_2010.nc4'),
                              ...
                              'PRISM_ppt_30yr_normal_800mM2_annual_bil.bil': os.path.join(STATIC_DATA_ROOT_PATH, 'PRISM_annual',
                                                                       'PRISM_ppt_30yr_normal_800mM2_annual_bil.bil'),  # added by Prasanna, for Nazmus's code to work
